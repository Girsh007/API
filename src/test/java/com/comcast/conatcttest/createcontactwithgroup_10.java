...
public class createcontactwithgroup_10

{
	@Test
	public void createConatctWithmarketgroup() throws Throwable {
		...
		String contactLastNAme  = elib.getExcelData("Contact", "tc_10", "LastName")+JavaUtils.getRanDomData();
		...
		//step 4 : Create new Contact With assigned to group as marketing & save info
		CreateNewConatct  cnc=new CreateNewConatct(driver);
		cnc.createContactwthgroup(contactLastNAme, 0);
