...
public class createcont_11 
{
   @Test
   public void createConatctWithsupport() throws Throwable {
		...
		WebDriver driver ;
		 ...
		 driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
			...
			//step 4 : Create new Contact With assigned to group as support & save info 
			CreateNewConatct  cnc=new CreateNewConatct(driver);
			cnc.createContactwthgroup(contactLastNAme, 1);
